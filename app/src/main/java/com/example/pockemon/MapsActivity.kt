...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    fun loadPockemons(){
        listOfPockemons.add(Pockemon(R.drawable.pikachu, "Pikachu","Pikachu living in japan", 55.0, 31.6214674, -8.0466887))
        listOfPockemons.add(Pockemon(R.drawable.evoli, "Evoli","Evoli living in usa", 90.5, 31.6214674, -8.0465778))
        listOfPockemons.add(Pockemon(R.drawable.snorlax, "chamander","chamander living in morocco", 33.5, 31.6214675, -8.0465668))
